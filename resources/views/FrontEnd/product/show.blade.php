                ...
                <div class="blog-item">
                    ...
                    <div class="blog-content">
                        ...
                        <div class="post-meta">
                            ...
                            <p><i class="fa fa-comment"></i> <a href="#">{{ $commentCount }}</a></p>
...
<script>
    $(".commentForm").submit(function(event){
        ...
        if(event.target[1].value.trim()!="" && !auth){
            noAuth();
        }
        $.ajax({
            headers: {
            ...
            error: function (data) {
                //console.log(event.target[1].value.trim());
    ...
    {{--  $('.replyForm').submit(function(event) {
       ...
       $.ajax({
        ...
        async: false,
        success: function(data) {
            $('#success-reply').css("display","block");
        },
        error: function(data) {
        }
    });  --}}
