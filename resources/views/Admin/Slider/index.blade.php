...
@endif
  <table id="slidersData" class="table table-bordered table-hover bg-white ml-2 Text">
     <thead>
         <tr>
             <th>id</th>
             <th>title</th>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(var i=0;i<size;i++){
                ...
                body    += "<td>" + data.data[i].title + "</td>";
                body    += "<td>" + str.slice(0, 20)+"..."+ "</td>";
                body    += "<td>" + data.data[i].link + "</td>";
                body    += "<td>" + data.data[i].action+ "</td>";
                body    += "</tr>";
                $( "#slidersData tbody" ).append(body);
            }
            $( "#slidersData" ).DataTable();
